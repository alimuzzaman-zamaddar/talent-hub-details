...
import { useResendOtpReset, useVerifyOtpReset } from "@/Hooks/api/auth_api";
...
export default function page() {
  ...
  const { mutate: verifyOtp, isPending } = useVerifyOtpReset();
  const { mutate: resendOtp, isPending: isResending } = useResendOtpReset();
